...
expect_contains "$classify_repair_budget_output" "name=RepairBudgetJournal.init body-class=native-only live-path=native-patch-candidate reason=memory-effect-builtin boundary=restricted-vm-candidate guidance=widen-restricted-vm"
