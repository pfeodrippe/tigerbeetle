...
classify_repair_budget_output="$(zig_hot classify src/vsr/repair_budget.zig 2>&1)"
expect_contains "$classify_repair_budget_output" "name=RepairBudgetJournal.init body-class=interpreter-ready live-path=dispatch-cell"
...
expect_contains "$pointer_alias_baseline" "value: 42"
pointer_alias_assoc="$(zig_hot assoc --no-native read_after_bump --file test/hot/local_pointer_alias_probe.zig 'pub fn read_after_bump(seed: i64) i64 { return seed + 10; }' 2>&1)"
expect_hot_success "$pointer_alias_assoc"
pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'read_after_bump(40)' 2>&1)"
expect_hot_success "$pointer_alias_patched"
expect_contains "$pointer_alias_patched" "value: 50"
pointer_alias_dissoc="$(zig_hot dissoc read_after_bump 2>&1)"
expect_hot_success "$pointer_alias_dissoc"
pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'read_after_bump(40)' 2>&1)"
expect_hot_success "$pointer_alias_restored"
expect_contains "$pointer_alias_restored" "value: 42"
echo "assoc/dissoc local pointer alias function: OK"

cast_memset_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'cast_memset_score(1)' 2>&1)"
expect_hot_success "$cast_memset_baseline"
expect_contains "$cast_memset_baseline" "value: 6666"
cast_memset_assoc="$(zig_hot assoc --no-native cast_memset_score --file test/hot/local_pointer_alias_probe.zig 'pub fn cast_memset_score(seed: i64) i64 { return seed + 80; }' 2>&1)"
expect_hot_success "$cast_memset_assoc"
cast_memset_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'cast_memset_score(1)' 2>&1)"
expect_hot_success "$cast_memset_patched"
expect_contains "$cast_memset_patched" "value: 81"
cast_memset_dissoc="$(zig_hot dissoc cast_memset_score 2>&1)"
expect_hot_success "$cast_memset_dissoc"
cast_memset_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'cast_memset_score(1)' 2>&1)"
expect_hot_success "$cast_memset_restored"
expect_contains "$cast_memset_restored" "value: 6666"
echo "assoc/dissoc casted-slice memory-effect function: OK"

deref_slice_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'deref_slice_score(1)' 2>&1)"
expect_hot_success "$deref_slice_baseline"
expect_contains "$deref_slice_baseline" "value: 1774"
deref_slice_assoc="$(zig_hot assoc --no-native deref_slice_score --file test/hot/local_pointer_alias_probe.zig 'pub fn deref_slice_score(seed: i64) i64 { return seed + 90; }' 2>&1)"
expect_hot_success "$deref_slice_assoc"
deref_slice_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'deref_slice_score(1)' 2>&1)"
expect_hot_success "$deref_slice_patched"
expect_contains "$deref_slice_patched" "value: 91"
deref_slice_dissoc="$(zig_hot dissoc deref_slice_score 2>&1)"
expect_hot_success "$deref_slice_dissoc"
deref_slice_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'deref_slice_score(1)' 2>&1)"
expect_hot_success "$deref_slice_restored"
expect_contains "$deref_slice_restored" "value: 1774"
echo "assoc/dissoc deref-slice memory-effect function: OK"

pointer_capture_field_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'pointer_capture_field_score(1)' 2>&1)"
expect_hot_success "$pointer_capture_field_baseline"
expect_contains "$pointer_capture_field_baseline" "value: 1233"
pointer_capture_field_assoc="$(zig_hot assoc --no-native pointer_capture_field_score --file test/hot/local_pointer_alias_probe.zig 'pub fn pointer_capture_field_score(seed: i64) i64 { return seed + 100; }' 2>&1)"
expect_hot_success "$pointer_capture_field_assoc"
pointer_capture_field_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'pointer_capture_field_score(1)' 2>&1)"
expect_hot_success "$pointer_capture_field_patched"
expect_contains "$pointer_capture_field_patched" "value: 101"
pointer_capture_field_dissoc="$(zig_hot dissoc pointer_capture_field_score 2>&1)"
expect_hot_success "$pointer_capture_field_dissoc"
pointer_capture_field_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'pointer_capture_field_score(1)' 2>&1)"
expect_hot_success "$pointer_capture_field_restored"
expect_contains "$pointer_capture_field_restored" "value: 1233"
echo "assoc/dissoc field pointer-capture function: OK"

array_address_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'array_address_alias_score(1)' 2>&1)"
expect_hot_success "$array_address_alias_baseline"
expect_contains "$array_address_alias_baseline" "value: 323"
array_address_alias_assoc="$(zig_hot assoc --no-native array_address_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn array_address_alias_score(seed: i64) i64 { return seed + 110; }' 2>&1)"
expect_hot_success "$array_address_alias_assoc"
array_address_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'array_address_alias_score(1)' 2>&1)"
expect_hot_success "$array_address_alias_patched"
expect_contains "$array_address_alias_patched" "value: 111"
array_address_alias_dissoc="$(zig_hot dissoc array_address_alias_score 2>&1)"
expect_hot_success "$array_address_alias_dissoc"
array_address_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'array_address_alias_score(1)' 2>&1)"
expect_hot_success "$array_address_alias_restored"
expect_contains "$array_address_alias_restored" "value: 323"
echo "assoc/dissoc array-address pointer alias function: OK"

field_address_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'field_address_alias_score(1)' 2>&1)"
expect_hot_success "$field_address_alias_baseline"
expect_contains "$field_address_alias_baseline" "value: 423"
field_address_alias_assoc="$(zig_hot assoc --no-native field_address_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn field_address_alias_score(seed: i64) i64 { return seed + 150; }' 2>&1)"
expect_hot_success "$field_address_alias_assoc"
field_address_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'field_address_alias_score(1)' 2>&1)"
expect_hot_success "$field_address_alias_patched"
expect_contains "$field_address_alias_patched" "value: 151"
field_address_alias_dissoc="$(zig_hot dissoc field_address_alias_score 2>&1)"
expect_hot_success "$field_address_alias_dissoc"
field_address_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'field_address_alias_score(1)' 2>&1)"
expect_hot_success "$field_address_alias_restored"
expect_contains "$field_address_alias_restored" "value: 423"
echo "assoc/dissoc field-address pointer alias function: OK"

address_of_field_capture_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'address_of_field_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$address_of_field_capture_baseline"
expect_contains "$address_of_field_capture_baseline" "value: 1233"
address_of_field_capture_assoc="$(zig_hot assoc --no-native address_of_field_pointer_capture_score --file test/hot/local_pointer_alias_probe.zig 'pub fn address_of_field_pointer_capture_score(seed: i64) i64 { return seed + 160; }' 2>&1)"
expect_hot_success "$address_of_field_capture_assoc"
address_of_field_capture_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'address_of_field_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$address_of_field_capture_patched"
expect_contains "$address_of_field_capture_patched" "value: 161"
address_of_field_capture_dissoc="$(zig_hot dissoc address_of_field_pointer_capture_score 2>&1)"
expect_hot_success "$address_of_field_capture_dissoc"
address_of_field_capture_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'address_of_field_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$address_of_field_capture_restored"
expect_contains "$address_of_field_capture_restored" "value: 1233"
echo "assoc/dissoc address-of-field pointer-capture function: OK"

switch_pointer_payload_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'switch_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$switch_pointer_payload_baseline"
expect_contains "$switch_pointer_payload_baseline" "value: 11"
switch_pointer_payload_assoc="$(zig_hot assoc --no-native switch_pointer_payload_score --file test/hot/local_pointer_alias_probe.zig 'pub fn switch_pointer_payload_score(seed: i64) i64 { return seed + 170; }' 2>&1)"
expect_hot_success "$switch_pointer_payload_assoc"
switch_pointer_payload_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'switch_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$switch_pointer_payload_patched"
expect_contains "$switch_pointer_payload_patched" "value: 171"
switch_pointer_payload_dissoc="$(zig_hot dissoc switch_pointer_payload_score 2>&1)"
expect_hot_success "$switch_pointer_payload_dissoc"
switch_pointer_payload_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'switch_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$switch_pointer_payload_restored"
expect_contains "$switch_pointer_payload_restored" "value: 11"
echo "assoc/dissoc switch pointer-payload function: OK"

nested_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$nested_pointer_alias_baseline"
expect_contains "$nested_pointer_alias_baseline" "value: 11"
nested_pointer_alias_assoc="$(zig_hot assoc --no-native nested_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn nested_pointer_alias_score(seed: i64) i64 { return seed + 180; }' 2>&1)"
expect_hot_success "$nested_pointer_alias_assoc"
nested_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$nested_pointer_alias_patched"
expect_contains "$nested_pointer_alias_patched" "value: 181"
nested_pointer_alias_dissoc="$(zig_hot dissoc nested_pointer_alias_score 2>&1)"
expect_hot_success "$nested_pointer_alias_dissoc"
nested_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$nested_pointer_alias_restored"
expect_contains "$nested_pointer_alias_restored" "value: 11"
echo "assoc/dissoc nested pointer-alias function: OK"

type_info_integer_bits_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$type_info_integer_bits_baseline"
expect_contains "$type_info_integer_bits_baseline" "value: 11"
type_info_integer_bits_assoc="$(zig_hot assoc --no-native type_info_integer_bits_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_integer_bits_score(seed: i64) i64 { return seed + 190; }' 2>&1)"
expect_hot_success "$type_info_integer_bits_assoc"
type_info_integer_bits_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$type_info_integer_bits_patched"
expect_contains "$type_info_integer_bits_patched" "value: 193"
type_info_integer_bits_dissoc="$(zig_hot dissoc type_info_integer_bits_score 2>&1)"
expect_hot_success "$type_info_integer_bits_dissoc"
type_info_integer_bits_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_integer_bits_score(3)' 2>&1)"
expect_hot_success "$type_info_integer_bits_restored"
expect_contains "$type_info_integer_bits_restored" "value: 11"
echo "assoc/dissoc typeInfo integer bits function: OK"

type_info_alias_bits_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$type_info_alias_bits_baseline"
expect_contains "$type_info_alias_bits_baseline" "value: 58"
type_info_alias_bits_assoc="$(zig_hot assoc --no-native type_info_alias_bits_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_alias_bits_score(seed: i64) i64 { return seed + 200; }' 2>&1)"
expect_hot_success "$type_info_alias_bits_assoc"
type_info_alias_bits_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$type_info_alias_bits_patched"
expect_contains "$type_info_alias_bits_patched" "value: 201"
type_info_alias_bits_dissoc="$(zig_hot dissoc type_info_alias_bits_score 2>&1)"
expect_hot_success "$type_info_alias_bits_dissoc"
type_info_alias_bits_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_alias_bits_score(1)' 2>&1)"
expect_hot_success "$type_info_alias_bits_restored"
expect_contains "$type_info_alias_bits_restored" "value: 58"
echo "assoc/dissoc typeInfo alias bits function: OK"

type_info_array_len_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$type_info_array_len_baseline"
expect_contains "$type_info_array_len_baseline" "value: 257"
type_info_array_len_assoc="$(zig_hot assoc --no-native type_info_array_len_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_array_len_score(seed: i64) i64 { return seed + 2560; }' 2>&1)"
expect_hot_success "$type_info_array_len_assoc"
type_info_array_len_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$type_info_array_len_patched"
expect_contains "$type_info_array_len_patched" "value: 2561"
type_info_array_len_dissoc="$(zig_hot dissoc type_info_array_len_score 2>&1)"
expect_hot_success "$type_info_array_len_dissoc"
type_info_array_len_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_array_len_score(1)' 2>&1)"
expect_hot_success "$type_info_array_len_restored"
expect_contains "$type_info_array_len_restored" "value: 257"
echo "assoc/dissoc typeInfo array len function: OK"

type_info_if_tag_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$type_info_if_tag_baseline"
expect_contains "$type_info_if_tag_baseline" "value: 13"
type_info_if_tag_assoc="$(zig_hot assoc --no-native type_info_if_tag_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_if_tag_score(seed: i64) i64 { return seed + 205; }' 2>&1)"
expect_hot_success "$type_info_if_tag_assoc"
type_info_if_tag_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$type_info_if_tag_patched"
expect_contains "$type_info_if_tag_patched" "value: 206"
type_info_if_tag_dissoc="$(zig_hot dissoc type_info_if_tag_score 2>&1)"
expect_hot_success "$type_info_if_tag_dissoc"
type_info_if_tag_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_if_tag_score(1)' 2>&1)"
expect_hot_success "$type_info_if_tag_restored"
expect_contains "$type_info_if_tag_restored" "value: 13"
echo "assoc/dissoc typeInfo if-tag function: OK"

type_info_fields_index_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$type_info_fields_index_baseline"
expect_contains "$type_info_fields_index_baseline" "value: 15"
type_info_fields_index_assoc="$(zig_hot assoc --no-native type_info_fields_index_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_fields_index_score(seed: i64) i64 { const fields = @typeInfo(FieldEnum).@"enum".fields; var total = seed; inline for (fields, 0..) |field, index| { total += field.value * @as(i64, @intCast(index + 10)); } return total; }' 2>&1)"
expect_hot_success "$type_info_fields_index_assoc"
type_info_fields_index_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$type_info_fields_index_patched"
expect_contains "$type_info_fields_index_patched" "value: 69"
type_info_fields_index_dissoc="$(zig_hot dissoc type_info_fields_index_score 2>&1)"
expect_hot_success "$type_info_fields_index_dissoc"
type_info_fields_index_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_fields_index_score(1)' 2>&1)"
expect_hot_success "$type_info_fields_index_restored"
expect_contains "$type_info_fields_index_restored" "value: 15"
echo "assoc/dissoc typeInfo fields index function: OK"

type_info_enum_count_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$type_info_enum_count_baseline"
expect_contains "$type_info_enum_count_baseline" "value: 13"
type_info_enum_count_assoc="$(zig_hot assoc --no-native type_info_enum_count_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_enum_count_score(seed: i64) i64 { return seed + 230; }' 2>&1)"
expect_hot_success "$type_info_enum_count_assoc"
type_info_enum_count_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$type_info_enum_count_patched"
expect_contains "$type_info_enum_count_patched" "value: 240"
type_info_enum_count_dissoc="$(zig_hot dissoc type_info_enum_count_score 2>&1)"
expect_hot_success "$type_info_enum_count_dissoc"
type_info_enum_count_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_count_score(10)' 2>&1)"
expect_hot_success "$type_info_enum_count_restored"
expect_contains "$type_info_enum_count_restored" "value: 13"
echo "assoc/dissoc typeInfo enum count function: OK"

type_info_enum_index_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$type_info_enum_index_baseline"
expect_contains "$type_info_enum_index_baseline" "value: 1"
type_info_enum_index_assoc="$(zig_hot assoc --no-native type_info_enum_index_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_enum_index_score(tag: FieldEnum) i64 { return @intFromEnum(tag) + 10; }' 2>&1)"
expect_hot_success "$type_info_enum_index_assoc"
type_info_enum_index_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$type_info_enum_index_patched"
expect_contains "$type_info_enum_index_patched" "value: 12"
type_info_enum_index_dissoc="$(zig_hot dissoc type_info_enum_index_score 2>&1)"
expect_hot_success "$type_info_enum_index_dissoc"
type_info_enum_index_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_enum_index_score(.b)' 2>&1)"
expect_hot_success "$type_info_enum_index_restored"
expect_contains "$type_info_enum_index_restored" "value: 1"
echo "assoc/dissoc typeInfo enum index function: OK"

type_of_if_condition_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$type_of_if_condition_baseline"
expect_contains "$type_of_if_condition_baseline" "value: 32"
type_of_if_condition_assoc="$(zig_hot assoc --no-native type_of_if_condition_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_of_if_condition_score(seed: i64) i64 { return seed + 310; }' 2>&1)"
expect_hot_success "$type_of_if_condition_assoc"
type_of_if_condition_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$type_of_if_condition_patched"
expect_contains "$type_of_if_condition_patched" "value: 311"
type_of_if_condition_dissoc="$(zig_hot dissoc type_of_if_condition_score 2>&1)"
expect_hot_success "$type_of_if_condition_dissoc"
type_of_if_condition_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_if_condition_score(1)' 2>&1)"
expect_hot_success "$type_of_if_condition_restored"
expect_contains "$type_of_if_condition_restored" "value: 32"
echo "assoc/dissoc TypeOf if-condition function: OK"

type_of_var_type_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$type_of_var_type_baseline"
expect_contains "$type_of_var_type_baseline" "value: 33"
type_of_var_type_assoc="$(zig_hot assoc --no-native type_of_var_type_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_of_var_type_score(seed: i64) i64 { return seed + 320; }' 2>&1)"
expect_hot_success "$type_of_var_type_assoc"
type_of_var_type_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$type_of_var_type_patched"
expect_contains "$type_of_var_type_patched" "value: 321"
type_of_var_type_dissoc="$(zig_hot dissoc type_of_var_type_score 2>&1)"
expect_hot_success "$type_of_var_type_dissoc"
type_of_var_type_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_of_var_type_score(1)' 2>&1)"
expect_hot_success "$type_of_var_type_restored"
expect_contains "$type_of_var_type_restored" "value: 33"
echo "assoc/dissoc TypeOf var-type function: OK"


type_info_pointer_optional_array_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$type_info_pointer_optional_array_baseline"
expect_contains "$type_info_pointer_optional_array_baseline" "value: 65"
type_info_pointer_optional_array_assoc="$(zig_hot assoc --no-native type_info_pointer_optional_array_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_pointer_optional_array_score(seed: i64) i64 { return seed + 260; }' 2>&1)"
expect_hot_success "$type_info_pointer_optional_array_assoc"
type_info_pointer_optional_array_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$type_info_pointer_optional_array_patched"
expect_contains "$type_info_pointer_optional_array_patched" "value: 261"
type_info_pointer_optional_array_dissoc="$(zig_hot dissoc type_info_pointer_optional_array_score 2>&1)"
expect_hot_success "$type_info_pointer_optional_array_dissoc"
type_info_pointer_optional_array_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_pointer_optional_array_score(1)' 2>&1)"
expect_hot_success "$type_info_pointer_optional_array_restored"
expect_contains "$type_info_pointer_optional_array_restored" "value: 65"
echo "assoc/dissoc typeInfo pointer/optional/array metadata function: OK"

type_info_struct_layout_tuple_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$type_info_struct_layout_tuple_baseline"
expect_contains "$type_info_struct_layout_tuple_baseline" "value: 25"
type_info_struct_layout_tuple_assoc="$(zig_hot assoc --no-native type_info_struct_layout_tuple_score --file test/hot/local_pointer_alias_probe.zig 'pub fn type_info_struct_layout_tuple_score(seed: i64) i64 { return seed + 270; }' 2>&1)"
expect_hot_success "$type_info_struct_layout_tuple_assoc"
type_info_struct_layout_tuple_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$type_info_struct_layout_tuple_patched"
expect_contains "$type_info_struct_layout_tuple_patched" "value: 280"
type_info_struct_layout_tuple_dissoc="$(zig_hot dissoc type_info_struct_layout_tuple_score 2>&1)"
expect_hot_success "$type_info_struct_layout_tuple_dissoc"
type_info_struct_layout_tuple_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'type_info_struct_layout_tuple_score(10)' 2>&1)"
expect_hot_success "$type_info_struct_layout_tuple_restored"
expect_contains "$type_info_struct_layout_tuple_restored" "value: 25"
echo "assoc/dissoc typeInfo struct layout/tuple metadata function: OK"

compile_error_guard_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$compile_error_guard_baseline"
expect_contains "$compile_error_guard_baseline" "value: 10"
compile_error_guard_assoc="$(zig_hot assoc --no-native compile_error_guard_score --file test/hot/local_pointer_alias_probe.zig 'pub fn compile_error_guard_score(seed: i64) i64 { return seed + 210; }' 2>&1)"
expect_hot_success "$compile_error_guard_assoc"
compile_error_guard_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$compile_error_guard_patched"
expect_contains "$compile_error_guard_patched" "value: 211"
compile_error_guard_dissoc="$(zig_hot dissoc compile_error_guard_score 2>&1)"
expect_hot_success "$compile_error_guard_dissoc"
compile_error_guard_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'compile_error_guard_score(1)' 2>&1)"
expect_hot_success "$compile_error_guard_restored"
expect_contains "$compile_error_guard_restored" "value: 10"
echo "assoc/dissoc compile-error reflection guard function: OK"

catch_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$catch_pointer_alias_baseline"
expect_contains "$catch_pointer_alias_baseline" "value: 15"
catch_pointer_alias_assoc="$(zig_hot assoc --no-native catch_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn catch_pointer_alias_score(seed: i64) i64 { return seed + 215; }' 2>&1)"
expect_hot_success "$catch_pointer_alias_assoc"
catch_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$catch_pointer_alias_patched"
expect_contains "$catch_pointer_alias_patched" "value: 216"
catch_pointer_alias_dissoc="$(zig_hot dissoc catch_pointer_alias_score 2>&1)"
expect_hot_success "$catch_pointer_alias_dissoc"
catch_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'catch_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$catch_pointer_alias_restored"
expect_contains "$catch_pointer_alias_restored" "value: 15"
echo "assoc/dissoc catch pointer-alias function: OK"

orelse_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$orelse_pointer_alias_baseline"
expect_contains "$orelse_pointer_alias_baseline" "value: 17"
orelse_pointer_alias_assoc="$(zig_hot assoc --no-native orelse_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn orelse_pointer_alias_score(seed: i64) i64 { return seed + 216; }' 2>&1)"
expect_hot_success "$orelse_pointer_alias_assoc"
orelse_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$orelse_pointer_alias_patched"
expect_contains "$orelse_pointer_alias_patched" "value: 217"
orelse_pointer_alias_dissoc="$(zig_hot dissoc orelse_pointer_alias_score 2>&1)"
expect_hot_success "$orelse_pointer_alias_dissoc"
orelse_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'orelse_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$orelse_pointer_alias_restored"
expect_contains "$orelse_pointer_alias_restored" "value: 17"
echo "assoc/dissoc orelse pointer-alias function: OK"

optional_pointer_payload_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$optional_pointer_payload_baseline"
expect_contains "$optional_pointer_payload_baseline" "value: 19"
optional_pointer_payload_assoc="$(zig_hot assoc --no-native optional_pointer_payload_score --file test/hot/local_pointer_alias_probe.zig 'pub fn optional_pointer_payload_score(seed: i64) i64 { return seed + 218; }' 2>&1)"
expect_hot_success "$optional_pointer_payload_assoc"
optional_pointer_payload_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$optional_pointer_payload_patched"
expect_contains "$optional_pointer_payload_patched" "value: 219"
optional_pointer_payload_dissoc="$(zig_hot dissoc optional_pointer_payload_score 2>&1)"
expect_hot_success "$optional_pointer_payload_dissoc"
optional_pointer_payload_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'optional_pointer_payload_score(1)' 2>&1)"
expect_hot_success "$optional_pointer_payload_restored"
expect_contains "$optional_pointer_payload_restored" "value: 19"
echo "assoc/dissoc optional pointer-payload function: OK"

zipped_pointer_capture_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$zipped_pointer_capture_baseline"
expect_contains "$zipped_pointer_capture_baseline" "value: 12454"
zipped_pointer_capture_assoc="$(zig_hot assoc --no-native zipped_pointer_capture_score --file test/hot/local_pointer_alias_probe.zig 'pub fn zipped_pointer_capture_score(seed: i64) i64 { return seed + 220; }' 2>&1)"
expect_hot_success "$zipped_pointer_capture_assoc"
zipped_pointer_capture_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$zipped_pointer_capture_patched"
expect_contains "$zipped_pointer_capture_patched" "value: 221"
zipped_pointer_capture_dissoc="$(zig_hot dissoc zipped_pointer_capture_score 2>&1)"
expect_hot_success "$zipped_pointer_capture_dissoc"
zipped_pointer_capture_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'zipped_pointer_capture_score(1)' 2>&1)"
expect_hot_success "$zipped_pointer_capture_restored"
expect_contains "$zipped_pointer_capture_restored" "value: 12454"
echo "assoc/dissoc zipped pointer-capture function: OK"

labeled_block_pointer_alias_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$labeled_block_pointer_alias_baseline"
expect_contains "$labeled_block_pointer_alias_baseline" "value: 23"
labeled_block_pointer_alias_assoc="$(zig_hot assoc --no-native labeled_block_pointer_alias_score --file test/hot/local_pointer_alias_probe.zig 'pub fn labeled_block_pointer_alias_score(seed: i64) i64 { var value = seed; const ptr = block: { break :block &value; }; ptr.* += 222; return value; }' 2>&1)"
expect_hot_success "$labeled_block_pointer_alias_assoc"
labeled_block_pointer_alias_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$labeled_block_pointer_alias_patched"
expect_contains "$labeled_block_pointer_alias_patched" "value: 223"
labeled_block_pointer_alias_dissoc="$(zig_hot dissoc labeled_block_pointer_alias_score 2>&1)"
expect_hot_success "$labeled_block_pointer_alias_dissoc"
labeled_block_pointer_alias_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_pointer_alias_score(1)' 2>&1)"
expect_hot_success "$labeled_block_pointer_alias_restored"
expect_contains "$labeled_block_pointer_alias_restored" "value: 23"
echo "assoc/dissoc labeled-block pointer-alias function: OK"

labeled_block_struct_store_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$labeled_block_struct_store_baseline"
expect_contains "$labeled_block_struct_store_baseline" "value: 43"
labeled_block_struct_store_assoc="$(zig_hot assoc --no-native labeled_block_struct_store_score --file test/hot/local_pointer_alias_probe.zig 'pub fn labeled_block_struct_store_score(seed: i64) i64 { var filters: [1]Filter = .{.{ .min = 0, .max = 0 }}; const filter: *Filter = block: { break :block &filters[0]; }; filter.* = .{ .min = seed + 20, .max = seed + 30 }; return filters[0].min * 10 + filters[0].max; }' 2>&1)"
expect_hot_success "$labeled_block_struct_store_assoc"
labeled_block_struct_store_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$labeled_block_struct_store_patched"
expect_contains "$labeled_block_struct_store_patched" "value: 263"
labeled_block_struct_store_dissoc="$(zig_hot dissoc labeled_block_struct_store_score 2>&1)"
expect_hot_success "$labeled_block_struct_store_dissoc"
labeled_block_struct_store_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'labeled_block_struct_store_score(3)' 2>&1)"
expect_hot_success "$labeled_block_struct_store_restored"
expect_contains "$labeled_block_struct_store_restored" "value: 43"
echo "assoc/dissoc labeled-block struct-store function: OK"

for_value_pointer_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'for_value_pointer_score(1)' 2>&1)"
expect_hot_success "$for_value_pointer_baseline"
expect_contains "$for_value_pointer_baseline" "value: 122"
for_value_pointer_assoc="$(zig_hot assoc --no-native for_value_pointer_score --file test/hot/local_pointer_alias_probe.zig 'pub fn for_value_pointer_score(seed: i64) i64 { return seed + 120; }' 2>&1)"
expect_hot_success "$for_value_pointer_assoc"
for_value_pointer_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'for_value_pointer_score(1)' 2>&1)"
expect_hot_success "$for_value_pointer_patched"
expect_contains "$for_value_pointer_patched" "value: 121"
for_value_pointer_dissoc="$(zig_hot dissoc for_value_pointer_score 2>&1)"
expect_hot_success "$for_value_pointer_dissoc"
for_value_pointer_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'for_value_pointer_score(1)' 2>&1)"
expect_hot_success "$for_value_pointer_restored"
...
bytes_view_memset_assoc="$(zig_hot assoc --no-native bytes_view_memset_score --file test/hot/local_pointer_alias_probe.zig 'pub fn bytes_view_memset_score(seed: u64) i64 { return @intCast(seed + 130); }' 2>&1)"
expect_hot_success "$bytes_view_memset_assoc"
bytes_view_memset_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'bytes_view_memset_score(1)' 2>&1)"
expect_hot_success "$bytes_view_memset_patched"
expect_contains "$bytes_view_memset_patched" "value: 131"
bytes_view_memset_dissoc="$(zig_hot dissoc bytes_view_memset_score 2>&1)"
expect_hot_success "$bytes_view_memset_dissoc"
bytes_view_memset_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'bytes_view_memset_score(1)' 2>&1)"
expect_hot_success "$bytes_view_memset_restored"
expect_contains "$bytes_view_memset_restored" "value: 555"
echo "assoc/dissoc bytesAsSlice memory-effect function: OK"

nested_local_memcpy_baseline="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_local_memcpy_score(1)' 2>&1)"
expect_hot_success "$nested_local_memcpy_baseline"
expect_contains "$nested_local_memcpy_baseline" "value: 123"
nested_local_memcpy_assoc="$(zig_hot assoc --no-native nested_local_memcpy_score --file test/hot/local_pointer_alias_probe.zig 'pub fn nested_local_memcpy_score(seed: i64) i64 { return seed + 140; }' 2>&1)"
expect_hot_success "$nested_local_memcpy_assoc"
nested_local_memcpy_patched="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_local_memcpy_score(1)' 2>&1)"
expect_hot_success "$nested_local_memcpy_patched"
expect_contains "$nested_local_memcpy_patched" "value: 141"
nested_local_memcpy_dissoc="$(zig_hot dissoc nested_local_memcpy_score 2>&1)"
expect_hot_success "$nested_local_memcpy_dissoc"
nested_local_memcpy_restored="$(zig_hot eval-zig test/hot/local_pointer_alias_probe.zig 'nested_local_memcpy_score(1)' 2>&1)"
expect_hot_success "$nested_local_memcpy_restored"
...
expect_contains "$classify_state_machine_output" "name=StateMachineType.batch_max body-class=invalidate-dependents live-path=invalidate-only reason=struct-container boundary=versioned-only guidance=reload-dependents"
expect_contains "$classify_state_machine_output" "name=StateMachineType.Options body-class=invalidate-dependents live-path=invalidate-only reason=struct-container boundary=versioned-only guidance=reload-dependents"
expect_contains "$classify_state_machine_output" "name=StateMachineType.Metrics body-class=invalidate-dependents live-path=invalidate-only reason=struct-container boundary=versioned-only guidance=reload-dependents"
expect_contains "$classify_state_machine_output" "name=StateMachineType.PrefetchContext body-class=invalidate-dependents live-path=invalidate-only reason=union-container boundary=versioned-only guidance=reload-dependents"
expect_contains "$classify_state_machine_output" "name=StateMachineType.ScanLookup body-class=invalidate-dependents live-path=invalidate-only reason=union-container boundary=versioned-only guidance=reload-dependents"
...
state_machine_forest_open_callback="$(zig_hot compile-body src/state_machine.zig StateMachineType.forest_open_callback 2>&1 || true)"
expect_contains "$state_machine_forest_open_callback" "fn: StateMachineType.forest_open_callback"
expect_contains "$state_machine_forest_open_callback" "err: execute failed: TypeMismatch"
echo "state_machine.zig parent-pointer callback compile-body reaches runtime pointer boundary: OK"
...
state_machine_forest_options_cache_probe="$(zig_hot compile-body hot_state_machine_probe.zig stateMachineForestOptionsCacheProbe 2>&1 || true)"
expect_hot_success "$state_machine_forest_options_cache_probe"
expect_contains "$state_machine_forest_options_cache_probe" "value: 7"
echo "state_machine.zig forest_options cache probe baseline: OK"
